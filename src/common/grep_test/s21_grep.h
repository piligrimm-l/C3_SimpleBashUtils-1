...
void print_error(const char* program_name, const char* file_name,
                 const char* message);
void* ptr_realloc(void* data, size_t* datq_size, size_t type_size);
void clean_pointer(void* ptr);
void n_option(const s_options_t* flags, const size_t* count_lines,
              const s_chcolor_t* colors);
void c_option(const s_options_t* flags, const s_list_t* paths, char* file_name,
              const size_t* count_matches, const s_chcolor_t* colors);
